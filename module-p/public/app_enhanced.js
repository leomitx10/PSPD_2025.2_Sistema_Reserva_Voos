...
document.getElementById('flight-form').addEventListener('submit', async (e) => {
    ...
    try {
        const formData = {
            ...
            data: document.getElementById('flight-departure-date').value,
            data_volta: document.getElementById('flight-return-date').value || '',
                ...
                <div class="package-section">
                    ...
                    <div class="card-details">
                        ...
                        <div class="detail-row">
                            ...
                            <div class="detail-item">
                                <span class="detail-label">Aeronave</span>
                                <span class="detail-value">${pkg.flight.aeronave}</span>
                            </div>
                        </div>
                    </div>
                </div>
